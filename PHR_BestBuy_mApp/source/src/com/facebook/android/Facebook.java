...
public class Facebook {
  ...
  /*  protected static String DIALOG_BASE_URL =
    ...
    private String[] mReconnectPermissions;
    ...
    public void authorize(Activity activity, String[] permissions,
        ...
        if (activityCode >= 0) {
            singleSignOnStarted = startSingleSignOn(activity, mAppId,
                    permissions.clone(), activityCode);
        }
        // Otherwise fall back to traditional dialog.
        if (!singleSignOnStarted) {
        	mReconnectPermissions = permissions.clone();
            startDialogAuth(activity, permissions.clone());
        }
    }
	...
	private void startDialogAuth(final Activity activity, String[] permissions) {
        ...
        dialog(activity, LOGIN, params, new DialogListener() {
            ...
            public void onComplete(Bundle values) {
                ...
                if (isSessionValid()) {
                	BBYLog.d("Facebook-authorize", "Login Success! access_token="
            ...
            public void onError(DialogError error) {
            	BBYLog.d("Facebook-authorize", "Login failed: " + error);
                mAuthDialogListener.onError(error);
                noConnectivityAlert(activity);
            }
            ...
            public void onCancel() {
            	BBYLog.d("Facebook-authorize", "Login canceled");
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (error != null) {
                    if (error.equals(SINGLE_SIGN_ON_DISABLED)
                    	...
                    	BBYLog.d("Facebook-authorize", "Hosted auth currently "
                            + "disabled. Retrying dialog auth...");
                        mReconnectPermissions = mAuthPermissions;
                        startDialogAuth(mAuthActivity, mAuthPermissions);
                    } else if (error.equals("access_denied")
                            || error.equals("OAuthAccessDeniedException")) {
                    	BBYLog.d("Facebook-authorize", "Login canceled by user.");
                        mAuthDialogListener.onCancel();
                    } else {
                    	BBYLog.d("Facebook-authorize", "Login failed: " + error);
    ...
    public String request(String graphPath, Bundle params, String httpMethod)
        ...
        String url = (graphPath != null) ? AppConfig.getFBDialogGraphURL() + graphPath
                                         : AppConfig.getFBRestServerURL();
    ...
    public void dialog(Context context, String action, Bundle parameters,
        ...
        String endpoint = AppConfig.getFBDialogBaseURL() + action;
    ...
    /**
	 * If no connectivity was detected , a connectivity
	 * alert dialog is displayed.
	 */
	public void noConnectivityAlert(final Activity activity) {
		BBYLog.d("Facebook-NoConnectivityAlert", "Internet Connectivity not available");
		NoConnectivityExtension.noConnectivity(activity, new OnReconnect() {
			public void onReconnect() {
				startDialogAuth(activity, mReconnectPermissions);
			}
		}, new OnCancel() {
			public void onCancel() {
				activity.finish();
