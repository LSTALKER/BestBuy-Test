  ...
  CaptureActivityHandler(CaptureActivity activity, Vector<BarcodeFormat> decodeFormats,
	...
	public void handleMessage(Message message) {
		...
		case R.id.auto_focus:
			// BBYLog.d(TAG, "Got auto-focus message");
		...
		case R.id.restart_preview:
			BBYLog.d(TAG, "Got restart preview message");
			restartPreviewAndDecode();
			break;
		case R.id.decode_succeeded:
			BBYLog.d(TAG, "Got decode succeeded message");
			state = State.SUCCESS;
		...
		case R.id.return_scan_result:
			BBYLog.d(TAG, "Got return scan result message");
			activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
			activity.finish();
			break;
		case R.id.launch_product_query:
			BBYLog.d(TAG, "Got product query message");
