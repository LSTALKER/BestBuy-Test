 ...
 * <p>
 * This class creates an instance of {@link SingleClientConnManager} for
 * connection management if not explicitly set.
 * <p>
 ...
 * @since 4.0
 */
public class MyDefaultHttpClient extends AbstractHttpClient {
	 ...
	 */
	public MyDefaultHttpClient(final ClientConnectionManager conman,
			final HttpParams params) {
		super(conman, params);
	}

	public MyDefaultHttpClient(final HttpParams params) {
		super(null, params);
	}
	...
	protected HttpContext createHttpContext() {
		...
		/*
		context.setAttribute(ClientContext.SCHEME_REGISTRY,
