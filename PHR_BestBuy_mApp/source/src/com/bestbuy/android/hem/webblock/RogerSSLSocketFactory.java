...
public class RogerSSLSocketFactory implements LayeredSocketFactory {
     ...
     */
    public static RogerSSLSocketFactory getSocketFactory() {
    ...
    public RogerSSLSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public RogerSSLSocketFactory(final KeyStore truststore) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
    ...
    public RogerSSLSocketFactory(final SSLContext sslContext)
    {
    ...
    private static TrustManager[] createTrustManagers(final KeyStore keystore)
    	...
    	tm[0] = new TrustEverythingSSLTrustManager();
    	return tm;
