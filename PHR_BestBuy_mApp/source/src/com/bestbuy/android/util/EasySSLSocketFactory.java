...
public class EasySSLSocketFactory implements SocketFactory,
	...
	private static final String TAG = "EasySSLSocketFactory.java";
	...
	private static SSLContext createEasySSLContext() throws IOException {
		try {
			...
			context.init(null,
					new TrustManager[] { new NonSecureTrustManager() }, null);
			return context;
		} catch (Exception e) {
	...
	// //return getSSLContext().getSocketFactory().createSocket();
	// return getSSLContext().getSocketFactory().createSocket(socket, host, 443,
	// autoClose);
	// }
	...
	private static class NonSecureTrustManager implements X509TrustManager {
